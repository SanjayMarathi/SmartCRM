...
function TopBar({ user, navigateToView, onSignOut, toggleTheme, theme, toggleSidebar }) {
  return (
    <header className="topbar">
      <div className="topbar-left">
        <button className="hamburger-btn" onClick={toggleSidebar} type="button" aria-label="Menu">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
        </button>
        <span style={{ fontSize: '0.85rem', color: 'var(--muted)', fontWeight: 500, marginLeft: '0.5rem' }} className="welcome-text">
        ...
        <section className="panel">
          <form className="ai-form" onSubmit={onAskAi}>
            <label className="full">Prompt
              <textarea rows="4" value={aiPrompt} onChange={e => setAiPrompt(e.target.value)} placeholder="e.g. Summarize my current pipeline and highlight leads stuck in negotiation..." required />
            </label>
            <div className="row-actions full" style={{ justifyContent: 'flex-end' }}>
              <button className="cta" disabled={aiChatBusy || !aiPrompt.trim()} type="submit">{aiChatBusy ? 'Thinking…' : 'Ask AI'}</button>
            </div>
          </form>
